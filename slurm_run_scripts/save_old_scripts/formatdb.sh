...
t='/lerins/hub/DB/HOMELIB/00_alienness/online/mega_accession2taxid'
o='/lerins/hub/projects/25_IPN_MetaNema/6-Pangenome/avp_all18P/formated_filtred_MetaSoil_NR_Eukprot_v2.faa'

#Run a search in blastp mode
$SING2 $SING_IMG python3 /lerins/hub/projects/25_20191015_git/python/nrFormated.py $f $t $o

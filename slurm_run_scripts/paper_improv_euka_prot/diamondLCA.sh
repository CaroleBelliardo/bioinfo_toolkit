...
#$SING2 $SING_IMG diamond blastp --top 20 --id 25 -b 8 -c 1 -p 30 --outfmt 102 -d ${DB} -q $QUERY -o $OUT
$SING2 $SING_IMG diamond blastp -b 8 -c 1 -p 40 -e 0.000001 --outfmt 102 -d ${DB} -q $QUERY -o $OUT

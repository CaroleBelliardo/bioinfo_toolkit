...
$SING2 $SING_IMG makeblastdb -dbtype nucl -input_type blastdb -in refseq_genomic -parse_seqids -taxid_map refseq_genomic_taxid -title refseq_taxo  -out refseq_taxo

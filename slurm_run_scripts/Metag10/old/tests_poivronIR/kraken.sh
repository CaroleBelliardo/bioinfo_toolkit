...
#SBATCH --mem=200G   # memory per Nodes
...
#$SING2 $SING_IMG kraken2-build --protein --threads 10 --build --db $db
#$SING2 $SING_IMG kraken2 --protein --threads 10 --db $db $infile --output $output

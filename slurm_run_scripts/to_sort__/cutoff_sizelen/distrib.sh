...
cut -f 2 /work/cbelliardo/4-seuil_cut-Metag/CAT_all-zero.txt |sort| uniq -c | sort > /work/cbelliardo/4-seuil_cut-Metag/CAT_all-zero_len.d
cut -f 3 /work/cbelliardo/4-seuil_cut-Metag/CAT_all-zero.txt |sort| uniq -c | sort > /work/cbelliardo/4-seuil_cut-Metag/CAT_all-zero_nbG.d

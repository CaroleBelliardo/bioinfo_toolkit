...
## -- makedb
SING_IMG='tools/kat_2.4.2'
SING2='singularity exec --bind /work/cbelliardo:/work/cbelliardo --bind /kwak/hub:/kwak/hub:rw'

cd /kwak/hub/25_cbelliardo/MISTIC/

$SING2 $SING_IMG  kat comp -t60 Salade_I/curve/HIFI/subsampling1/hifi_reads_1.fasta Salade_I/curve/illumina/fastq_sampling/subsampling1/illumina_reads_R1_0.1.fastq -o test2

...
cd /lerins/hub/projects/25_IPN_Metag/10Metag/assembly/test_vs_metaF
db='aubergine_I_oct__hifi_reads.fasta' # hifiasm
in='assembly.fasta' # metaflye
out='metaflyeQuery_vs_hifiasmDB.blast'

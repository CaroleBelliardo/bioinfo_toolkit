...
#SBATCH -J "subsampR22"   # job name
#SBATCH --mail-user=carole.belliardo@inrae.fr   # email address
#SBATCH --mail-type=ALL
#SBATCH -e slurm-sspR22-%j.err
#SBATCH -o slurm-sspR22-%j.out
#SBATCH -p all
...
out='subsampling1'
$SING2 $SING_IMG rasusa -s100 -n 284533487 -i $illumina_reads_R1 -o ${out}/illumina_reads_R2_0.2.fasta -O g

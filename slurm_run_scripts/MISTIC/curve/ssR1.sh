...
#SBATCH -J "subsampR1"   # job name
#SBATCH --mail-user=carole.belliardo@inrae.fr   # email address
#SBATCH --mail-type=ALL
#SBATCH -e slurm-sspR1-%j.err
#SBATCH -o slurm-sspR1-%j.out
#SBATCH -p all
...
out='subsampling1'
$SING2 $SING_IMG rasusa -s100 -n 569066975 -i $illumina_reads_R1 -o ${out}/illumina_reads_R1_0.4.fasta -O g

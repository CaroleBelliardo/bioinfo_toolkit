...
#SBATCH --mem=180G   # memory per Nodes   #38
...
cd "/kwak/hub/25_cbelliardo/MISTIC/Salade_I/mapping_SR_LR_reads"
bam='cleaned_pool__vs__hifireads.bam.sorted'
...
$SING2 $SING_IMG samtools stats --threads $SLURM_JOB_CPUS_PER_NODE  $bam > $bam.stats
check_command

...
avp_path=/lerins/hub/projects/25_Metag_PublicData/tools_metagData/AvP/avp
...
wd='/lerins/hub/projects/25_IPN_MetaNema/6-Pangenome/3_avp_cat18P_4_AI_or_HS_missing2'
cd $wd
...
ai_out='1-all18P.dmd_ai.out_AIpos_AHSpos_missing2'
out='avp_fastree_75'

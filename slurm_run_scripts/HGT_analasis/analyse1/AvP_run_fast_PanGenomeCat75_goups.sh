...
dmd='all18P.dmd'
out='avp_fastree_groups_cat_with_test'
...
$SING2 $SING_IMG /lerins/hub/projects/25_Metag_PublicData/tools_metagData/AvP/avp classify -i $out/fasttree_nexus/ -t ${out}/fasttree_tree_results.txt -f $classif -c $avpC -o $out

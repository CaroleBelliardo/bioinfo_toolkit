...
#SBATCH --mem=24G   # memory per Nodes   #38
#SBATCH -J "AvP"   # job name
#SBATCH --mail-user=carole.belliardo@inrae.fr   # email address
#SBATCH --mail-type=ALL
#SBATCH -e slurm-av_gt-%j.err
#SBATCH -o slurm-av_gt-%j.out
#SBATCH -p  infinity
...
group_test='newGroup_unionIPR_test.tsv'
#all_groupFile='/lerins/hub/projects/25_IPN_MetaNema/6-Pangenome/3_avp_cat18P_4_AI_or_HS/newGroup_unionIPR.tsv'

$SING2 $SING_IMG $avp_path prepare -y $group_test -a $ai_out -o $out -f $spe_fasta -b $dmd -x $avpX -c $avpC

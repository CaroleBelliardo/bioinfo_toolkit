...
avpX='/lerins/hub/projects/25_IPN_MetaNema/66_Pangenome_clean/NEW_analyse/avp/pg_sample.groups.yaml'
avpC='/lerins/hub/projects/25_IPN_MetaNema/66_Pangenome_clean/NEW_analyse/avp/pg_fast_sample.config.yaml'
out='/lerins/hub/projects/25_IPN_MetaNema/66_Pangenome_clean/NEW_analyse/avp/'
cd $out
$SING2 $SING_IMG $avp_path classify -i $out/fasttree_nexus2/ -t ${out}/fasttree_tree_results.txt2 -f $classif -c $avpC -o $out

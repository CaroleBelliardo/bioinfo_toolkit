...
cd /lerins/hub/projects/25_MetaNema/10Metag/fasta
FILES=($(ls -1 *.fasta))
...
out=/lerins/hub/projects/25_MetaNema/10Metag/fasta/mmseq2_Results_contigs/$FILENAME
tmp=tmp_mmseq_contigs/$FILENAME
